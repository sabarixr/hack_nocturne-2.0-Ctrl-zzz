...
class EmergencyFrame(models.Model):
    ...
    emotion_angry = models.FloatField(default=0.0)
    emotion_sad = models.FloatField(default=0.0)
    emotion_neutral = models.FloatField(default=0.0)
    emotion_happy = models.FloatField(default=0.0)
    emotion_surprise = models.FloatField(default=0.0)
    emotion_afraid = models.FloatField(default=0.0)
    emotion_disgust = models.FloatField(default=0.0)
